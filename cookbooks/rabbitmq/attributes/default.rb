...
default['rabbitmq']['version'] = '3.6.11'
...
default['rabbitmq']['ssl_cacert'] = '/etc/ssl/cacert.crt'
default['rabbitmq']['ssl_cert'] = '/etc/ssl/cert.crt'
default['rabbitmq']['ssl_key'] = '/etc/ssl/ca.key'
default['rabbitmq']['ssl_verify'] = 'verify_peer'
...
default['rabbitmq']['enabled_users'] =
  [{ :name => 'guest', :password => 'guest', :tag => 'management', :rights => [{ :vhost => '/', :conf => '.*', :write => '.*', :read => '.*' }]},
  { :name => 'admin', :password => 'password', :tag => 'administrator', :rights => [{ :vhost => '/', :conf => '.*', :write => '.*', :read => '.*' }]}
]
